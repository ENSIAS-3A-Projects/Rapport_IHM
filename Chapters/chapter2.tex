...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{imgs/safae.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{imgs/automobiliste.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{imgs/chauffeur.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{imgs/touriste_fiche.png}
\end{figure}
...
Cette problématique se décompose en trois axes de conception :

\begin{enumerate}
    \item \textbf{L'Axe Informationnel (Réassurance) :} Garantir la géolocalisation précise.
    \item \textbf{L'Axe Transactionnel (Fluidité) :} Achat instantané de titres de transport.
    \item \textbf{L'Axe Opérationnel (Efficacité) :} Réduire la charge mentale du conducteur.
\end{enumerate}